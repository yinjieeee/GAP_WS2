...
% 論文名稱
\newcommand{\chineseTitle}{以拓樸最佳化全介質奈米結構將 WS\textsubscript{2} 谷極化激子發光轉換為高純度拉格耳–高斯光束}
\newcommand{\englishTitle}{Topology-Optimized All-Dielectric GaP Nanostructures for Converting Valley-Polarized WS\textsubscript{2} Exciton Emission into High-Purity Laguerre--Gaussian Beams}
% 論文名稱太長的話, 可以修改covers/inside_var.tex 的顯示語法, 詳情寫在那邊

% 自己的名字 (英文名字有兩種寫法, 一個是姓在後, 一個是放前面還有逗號. )
\newcommand{\studentCnName}{程茵婕}
\newcommand{\studentEnName}{Cheng, Yin-Jie} % 書名頁
...
\newcommand{\NameofDepartmentInstituteCN}{光電研究所} % 系所名稱, 請看下方[說明1]
...
\input{Sections/2.Literature_Review} \newpage
