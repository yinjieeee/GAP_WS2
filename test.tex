...
\begin{frame}[plain]
  \begin{tikzpicture}[remember picture, overlay]
    ...
    \node[white,font=\large] at ([yshift=-1.2cm]current page.center){Convergence $\cdot$ Structures $\cdot$ Far-Field $\cdot$ Chirality Propagation $\cdot$ Valley Selectivity};
  \end{tikzpicture}
\end{frame}
...
\centering 
\begin{tabular}{cccc}
\includegraphics[width=0.23\textwidth,height=3.3cm,keepaspectratio]{img/017_ff_iter_257_beta_512.00.png} & \includegraphics[width=0.23\textwidth,height=3.3cm,keepaspectratio]{img/018_ff_iter_282_beta_512.00.png} & \includegraphics[width=0.23\textwidth,height=3.3cm,keepaspectratio]{img/013_ff_iter_282_beta_512.00.png} & \includegraphics[width=0.23\textwidth,height=3.3cm,keepaspectratio]{img/020_ff_iter_282_beta_512.00.png} \\ {\small (a) $\ell=0$} & {\small (b) $\ell=1$} & {\small (c) $\ell=2$} & {\small (d) $\ell=3$} \\ 
\end{tabular}\\[6pt] 
...
\begin{frame}{Device Energy Efficiency}
  \begin{columns}[T]
    ...
    \column{0.42\textwidth}
      ...
      \end{exampleblock}
      \vspace{1pt}
      \begin{alertblock}{Device Energy Efficiency}
        \centering
...
\begin{columns}[T]
  ...
  \begin{tabular}{lccccc}
    ...
    Guo 2016    & Forward (PB+prop) & -- & $>$90\%     & Passive PW & \red{None} \\
    ...
    \textbf{This work} & \textbf{Inverse (topo.\ opt.)} & $20.25 \mu m^2$ & \textbf{82--98\%} & \textbf{Active $\text{WS}_2$} & \makecell{\textbf{Valley coherent} \\ \textcolor{green!60!black}{\textbf{$>$100:1}}} \\
    \bottomrule
  \end{tabular}
\end{frame}
